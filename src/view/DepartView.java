...
//    IDepartmentController idc = new DepartmentController(db.getConnection());
    ...
    public void showTable() {
        ...
        departments = idc.getAll();
        for (int i = 0; i < departments.size(); i++) {
            row[0] = i + 1;
            row[1] = departments.get(i).getDepartmentId();
            row[2] = departments.get(i).getDepartmentName();
            if (departments.get(i).getManagerId()==null) {
                row[3] = "";
            } else {
                row[3] = departments.get(i).getManagerId().getEmployeeId();
            }
//            row[3] = null;
//            System.out.println(departments.get(i).getManagerId().getEmployeeId());
//            row[3] = departments.get(i).;
            row[4] = departments.get(i).getLocationId().getCity();
            model.addRow(row);
        }
    }
...
//            row[3] = departments.get(i).getManagerId();
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            JOptionPane.showMessageDialog(null, idc.delete(new Department(new Short(id.getText()))));
            updateTable();
            resetText();
        }
